...
var App = function() {
    ...
    var uiHandleTheme = function() {
        ...
        jQuery('[data-toggle="theme"]').on('click', function(){
            ...
            Ieasynet.loading();
            jQuery.get(ieasynet.theme_url, {theme: $theme}, function (res) {
    ...
    var uiHelperCkeditor = function(){
        ...
        jQuery('.js-ckeditor').each(function () {
            ...
            var editor    = CKEDITOR.replace(editor_id, {
                filebrowserImageUploadUrl: ieasynet.ckeditor_img_upload_url,
                image_previewText: ' ',
            ...
            $summernote.summernote({
                ...
                callbacks: {
                    onImageUpload: function(files) {
                        ...
                        $.ajax({
                            url : ieasynet.image_upload_url,//后台文件上传接口
                            type : 'POST',
                            data : formData,
                            cache: false,
                            processData : false,
                            ...
                            success : function(res) {
                                if (res.status == 1) {
                                    ...
                                    Ieasynet.notify(res.info, 'danger');
                                }
                            }
                        });
                    }
