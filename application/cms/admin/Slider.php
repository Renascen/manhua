...
class Slider extends Admin
{
    ...
    public function index()
    {
        ...
        $order = $this->getOrder();
        // 数据列表
        $data_list = SliderModel::join('ien_book', 'ien_book.id=ien_cms_slider.bid', 'left')->field('ien_cms_slider.*,ien_book.title as bookname')->where($map)->order($order)->paginate();
