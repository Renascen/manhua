...
class Index extends Admin
{
    ...
    public function checkUpdate()
    {
        ...
        //     CURLOPT_URL            => config('ieasynet.product_update'),
        ...
        // if ($result['code'] == 1) {
        //     return json([
        //         'update' => '<a class="badge badge-primary" href="http://www.ieasynet.com/download" target="_blank">有新版本：'.$result["version"].'</a>',
        //         'auth'   => $result['auth']
        //     ]);
        // } else {
        //     return json([
