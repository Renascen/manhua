<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:51:"D:\test/application/cms/view/admin/index\index.html";i:1512980733;s:42:"D:\test/application/admin/view/layout.html";i:1513080454;s:46:"./application/common/builder/aside/layout.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/recent.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/online.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/switch.html";i:1512980735;}*/ ?>
<!DOCTYPE html>
...
<div class="row">
    <div class="col-sm-6 col-md-3">
        <a class="block block-link-hover3 text-center" href="<?php echo url('document/index'); ?>">
            <div class="block-content block-content-full">
                <div class="h1 font-w700 text-primary" data-toggle="countTo" data-to="<?php echo (isset($document) && ($document !== '')?$document:0); ?>"></div>
            </div>
    ...
    <div class="col-sm-6 col-md-3">
        <a class="block block-link-hover3 text-center" href="<?php echo url('column/index'); ?>">
            <div class="block-content block-content-full">
                <div class="h1 font-w700 text-success" data-toggle="countTo" data-to="<?php echo (isset($column) && ($column !== '')?$column:0); ?>"></div>
            </div>
    ...
    <div class="col-sm-6 col-md-3">
        <a class="block block-link-hover3 text-center" href="<?php echo url('page/index'); ?>">
            <div class="block-content block-content-full">
                <div class="h1 font-w700 text-info" data-toggle="countTo" data-to="<?php echo (isset($page) && ($page !== '')?$page:0); ?>"></div>
            </div>
    ...
    <div class="col-sm-6 col-md-3">
        <a class="block block-link-hover3 text-center" href="<?php echo url('model/index'); ?>">
            <div class="block-content block-content-full">
                <div class="h1 font-w700 text-warning"><span data-toggle="countTo" data-to="<?php echo (isset($model) && ($model !== '')?$model:0); ?>"></span></div>
            </div>
