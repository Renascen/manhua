<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"D:\test/application/common/builder/table/layout.html";i:1512980735;s:42:"D:\test/application/admin/view/layout.html";i:1513080454;s:46:"./application/common/builder/aside/layout.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/recent.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/online.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/switch.html";i:1512980735;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="block">
                ...
                <div class="block-content tab-content">
                    <div class="tab-pane active">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="toolbar-btn-action">
                                    ...
                                    <div class="form-inline time-filter">
                                        <div class="time-filter" id="_end_time">
                        ...
                        <table class="table table-builder table-hover table-bordered table-striped js-table-checkable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="column-<?php echo $column['name']; ?> <?php echo (isset($column['class']) && ($column['class'] !== '')?$column['class']:''); ?>" style="font-size: 0.75em; padding: 2px;text-align: center;">
                            ...
                            <tbody  style="font-size: 0.75em;text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <?php endif; if(is_array($columns) || $columns instanceof \think\Collection || $columns instanceof \think\Paginator): $i = 0; $__LIST__ = $columns;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$column): $mod = ($i % 2 );++$i;?>
                                    <td class="<?php echo (isset($column['class']) && ($column['class'] !== '')?$column['class']:''); ?>" style="padding: 2px">
                        ...
                        <div class="data-table-toolbar" style="min-width: 315px;font-size: 0.75em;">
                            <div class="row">
                                <div class="col-sm-12">
