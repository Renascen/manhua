<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"D:\test/application/admin\view\menu\index.html";i:1512980734;s:42:"D:\test/application/admin\view\layout.html";i:1513080454;s:46:"./application/common/builder/aside/layout.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/recent.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/online.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/switch.html";i:1512980735;}*/ ?>
<!DOCTYPE html>
        ...
        $('#save').click(function(){
            ...
            $.post("<?php echo url('save'); ?>", {menus: $('#menu_list').nestable('serialize')}, function(data) {
                ...
                if (data.code) {
                    ...
                    Ieasynet.notify(data.msg, 'success');
                } else {
                    Ieasynet.notify(data.msg, 'danger');
                }
            });
        });
