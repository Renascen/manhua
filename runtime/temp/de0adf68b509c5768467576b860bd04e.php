<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"D:\manhua/application/user/view/admin/publics\signin.html";i:1512980736;}*/ ?>
<!DOCTYPE html>
...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="zh"> <!--<![endif]-->
    ...
    <body>
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                        <div class="push-30-t push-50 animated fadeIn">
                            ...
                            <div class="text-center">
                                <img src="__ADMIN_IMG__/logo-signin.png?v1.4.0" alt="火豚中文后台管理系统" style="width:120px">
                                <p class="text-muted push-15-t" style="font-size:20px;font-weight: 550;color:#000">火豚中文后台管理系统</p>
                            </div>
                            <!-- END Login Title -->
        ...
        <div class="pulldown push-30-t text-center animated fadeInUp">
            <small class="text-muted"><?php echo config('web_site_copyright'); ?></small>
        </div>
        <div>
            <a href="http://www.miitbeian.gov.cn"><?php echo config('web_site_icp'); ?></a>
        </div>
        <!-- END Login Footer -->
            ...
            $(document).ready(function () {
                $('.signin-form').on('submit', function () {
                    ...
                    $.post($(this).attr('action'), $data, function (res) {
                        ...
                        if (res.code) {
                            Ieasynet.notify('登录成功，页面即将跳转~', 'success');
                            setTimeout(function () {
