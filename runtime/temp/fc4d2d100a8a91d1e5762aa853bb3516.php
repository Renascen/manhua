<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"D:\test/application/admin/view/dispatch_jump.tpl";i:1512980734;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <title>跳转提示 | <?php echo config('web_site_title'); ?> - IeasynetPHP</title>
    ...
    <link rel="stylesheet" id="css-main" href="__ADMIN_CSS__/ieasynet.css">
    <!-- END Stylesheets -->
</head>
<body>
<!-- Error Content -->
...
<div class="content pulldown text-muted text-center">
    极简 · 极速 · 极致<br>
    浩森PHP，让开发更简单！<br>
    由 <a class="link-effect" href="http://www.ieasynet.com">IeasynetPHP</a> 强力驱动 <a class="link-effect" href="http://www.ieasynet.com">浩森宇特</a> 倾情奉献
</div>
<!-- END Error Footer -->
