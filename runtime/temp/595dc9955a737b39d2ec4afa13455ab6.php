<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:60:"D:\test/application/agent/view/admin/statistical\paylog.html";i:1512980735;s:42:"D:\test/application/admin/view/layout.html";i:1512980734;s:46:"./application/common/builder/aside/layout.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/recent.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/online.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/switch.html";i:1512980735;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo (isset($page_title) && ($page_title !== '')?$page_title:'后台'); ?> | <?php echo config('web_site_title'); ?> - IeasynetPHP</title>
    ...
    <link rel="shortcut icon" href="__ADMIN_IMG__/favicons/favicon.ico?v1.4.1">

    <link rel="icon" type="image/png" href="__ADMIN_IMG__/favicons/favicon-16x16.png?v1.4.1" sizes="16x16">
    <link rel="icon" type="image/png" href="__ADMIN_IMG__/favicons/favicon-32x32.png?v1.4.1" sizes="32x32">
    <link rel="icon" type="image/png" href="__ADMIN_IMG__/favicons/favicon-96x96.png?v1.4.1" sizes="96x96">
    <link rel="icon" type="image/png" href="__ADMIN_IMG__/favicons/favicon-160x160.png?v1.4.1" sizes="160x160">
    <link rel="icon" type="image/png" href="__ADMIN_IMG__/favicons/favicon-192x192.png?v1.4.1" sizes="192x192">

    <link rel="apple-touch-icon" sizes="57x57" href="__ADMIN_IMG__/favicons/apple-touch-icon-57x57.png?v1.4.1">
    <link rel="apple-touch-icon" sizes="60x60" href="__ADMIN_IMG__/favicons/apple-touch-icon-60x60.png?v1.4.1">
    <link rel="apple-touch-icon" sizes="72x72" href="__ADMIN_IMG__/favicons/apple-touch-icon-72x72.png?v1.4.1">
    <link rel="apple-touch-icon" sizes="76x76" href="__ADMIN_IMG__/favicons/apple-touch-icon-76x76.png?v1.4.1">
    <link rel="apple-touch-icon" sizes="114x114" href="__ADMIN_IMG__/favicons/apple-touch-icon-114x114.png?v1.4.1">
    <link rel="apple-touch-icon" sizes="120x120" href="__ADMIN_IMG__/favicons/apple-touch-icon-120x120.png?v1.4.1">
    <link rel="apple-touch-icon" sizes="144x144" href="__ADMIN_IMG__/favicons/apple-touch-icon-144x144.png?v1.4.1">
    <link rel="apple-touch-icon" sizes="152x152" href="__ADMIN_IMG__/favicons/apple-touch-icon-152x152.png?v1.4.1">
    <link rel="apple-touch-icon" sizes="180x180" href="__ADMIN_IMG__/favicons/apple-touch-icon-180x180.png?v1.4.1">
    <!-- END Icons -->
    ...
    <link rel="stylesheet" href="__ADMIN_CSS__/ieasynet.css" id="css-main">
    <?php endif; ?>
    ...
    <aside id="side-overlay">
        ...
        <div id="side-overlay-scroll">
            ...
            <div class="side-header side-content">
                ...
                <span>
                    <img class="img-avatar img-avatar32" src="__ADMIN_IMG__/avatar.png?v1.4.1" alt="">
            ...
            <div class="sidebar-content">
                ...
                <div class="side-header side-content bg-white-op ieasynet-header">
                    ...
                    <a class="h5 text-white" href="<?php echo url('admin/index/index'); ?>">
                        ...
                        <img src="<?php echo get_file_path(\think\Config::get('web_site_logo')); ?>" class="logo" alt="<?php echo (\think\Config::get('web_site_title') ?: 'Ieasynet PHP'); ?>">
                        <?php else: ?>
                        <img src="<?php echo \think\Config::get('public_static_path'); ?>admin/img/logo.png" class="logo" alt="Ieasynet PHP">
                        ...
                        <img src="<?php echo get_file_path(\think\Config::get('web_site_logo_text')); ?>" class="logo-text sidebar-mini-hide" alt="<?php echo (\think\Config::get('web_site_title') ?: 'Ieasynet PHP'); ?>">
                        <?php else: ?>
                        <img src="<?php echo \think\Config::get('public_static_path'); ?>admin/img/logo-text.png" class="logo-text sidebar-mini-hide" alt="Ieasynet PHP">
                        <?php endif; ?>
                    </a>
                </div>
                <!-- END Side Header -->
   ...
   <div class="row" id="order-summary-stats-panel">
    <div class="col-md-3">
        <div class="well">
            ...
            <div class="text-primary" style="font-size:32px;margin:5px 0">
                ¥<span data-bind="price: stats_today.paid_amount"><?php echo $pay_today['pay_num']; ?></span>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6" style="padding:0">
                        <strong>普通充值</strong>
                        <div><b class="text-primary" data-bind="price: stats_today.welth_order_paid_amount"><?php echo $pay_today['pay_ptnum']; ?></b></div>
                        <div>已支付: <b class="text-warning" data-bind="text: stats_today.welth_order_paid_count"><?php echo $pay_today['pay_ptok']; ?></b> 笔</div>
                        <div>未支付: <b class="text-warning" data-bind="text: stats_today.welth_order_unpaid_count"><?php echo $pay_today['pay_ptno']; ?></b> 笔</div>
                        <div>
                            完成率: <b class="text-warning"><span data-bind="text: Math.round(stats_today.welth_order_completion_rate() * 100)"><?php echo $pay_today['pay_ptp']; ?></span> %</b>
                        </div>
                    </div>
                    <div class="col-sm-6" style="padding:0">
                        <strong>年费VIP会员</strong>
                        <div><b class="text-primary" data-bind="price: stats_today.vip_order_paid_amount"><?php echo $pay_today['pay_vipnum']; ?></b></div>
                        <div>已支付: <b class="text-warning" data-bind="text: stats_today.vip_order_paid_count"><?php echo $pay_today['pay_vipok']; ?></b> 笔</div>
                        <div>未支付: <b class="text-warning" data-bind="text: stats_today.vip_order_unpaid_count"><?php echo $pay_today['pay_vipno']; ?></b> 笔</div>
                        <div>
                            完成率: <b class="text-warning"><span data-bind="text: Math.round(stats_today.vip_order_completion_rate() * 100)"><?php echo $pay_today['pay_vipp']; ?></span> %</b>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-3">
        <div class="well">
            <b>昨日充值</b>
            <div class="text-primary" style="font-size:32px;margin:5px 0">
                ¥<span data-bind="price: stats_yesterday.paid_amount"><?php echo $pay_yesterday['pay_num']; ?></span>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6" style="padding:0">
                        <strong>普通充值</strong>
                        <div><b class="text-primary" data-bind="price: stats_yesterday.welth_order_paid_amount"><?php echo $pay_yesterday['pay_ptnum']; ?></b></div>
                        <div>已支付: <b class="text-warning" data-bind="text: stats_yesterday.welth_order_paid_count"><?php echo $pay_yesterday['pay_ptok']; ?></b> 笔</div>
                        <div>未支付: <b class="text-warning" data-bind="text: stats_yesterday.welth_order_unpaid_count"><?php echo $pay_yesterday['pay_ptno']; ?></b> 笔</div>
                        <div>
                            完成率: <b class="text-warning"><span data-bind="text: Math.round(stats_yesterday.welth_order_completion_rate() * 100)"><?php echo $pay_yesterday['pay_ptp']; ?></span> %</b>
                        </div>
                    </div>
                    <div class="col-sm-6" style="padding:0">
                        <strong>年费VIP会员</strong>
                        <div><b class="text-primary" data-bind="price: stats_yesterday.vip_order_paid_amount"><?php echo $pay_yesterday['pay_vipnum']; ?></b></div>
                        <div>已支付: <b class="text-warning" data-bind="text: stats_yesterday.vip_order_paid_count"><?php echo $pay_yesterday['pay_vipok']; ?></b> 笔</div>
                        <div>未支付: <b class="text-warning" data-bind="text: stats_yesterday.vip_order_unpaid_count"><?php echo $pay_yesterday['pay_vipno']; ?></b> 笔</div>
                        <div>
                            完成率: <b class="text-warning"><span data-bind="text: Math.round(stats_yesterday.vip_order_completion_rate() * 100)"><?php echo $pay_yesterday['pay_vipp']; ?></span> %</b>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-3">
        <div class="well">
            ...
            <div class="text-primary" style="font-size:32px;margin:5px 0">
                ¥<span data-bind="price: stats_this_month.paid_amount"><?php echo $pay_month['pay_num']; ?></span>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6" style="padding:0">
                        <strong>普通充值</strong>
                        <div><b class="text-primary" data-bind="price: stats_this_month.welth_order_paid_amount"><?php echo $pay_month['pay_ptnum']; ?></b></div>
                        <div>已支付: <b class="text-warning" data-bind="text: stats_this_month.welth_order_paid_count"><?php echo $pay_month['pay_ptok']; ?></b> 笔</div>
                        <div>未支付: <b class="text-warning" data-bind="text: stats_this_month.welth_order_unpaid_count"><?php echo $pay_month['pay_ptno']; ?></b> 笔</div>
                        <div>
                            完成率: <b class="text-warning"><span data-bind="text: Math.round(stats_this_month.welth_order_completion_rate() * 100)"><?php echo $pay_month['pay_ptp']; ?></span> %</b>
                        </div>
                    </div>
                    <div class="col-sm-6" style="padding:0">
                        <strong>年费VIP会员</strong>
                        <div><b class="text-primary" data-bind="price: stats_this_month.vip_order_paid_amount"><?php echo $pay_month['pay_vipnum']; ?></b></div>
                        <div>已支付: <b class="text-warning" data-bind="text: stats_this_month.vip_order_paid_count"><?php echo $pay_month['pay_vipok']; ?></b> 笔</div>
                        <div>未支付: <b class="text-warning" data-bind="text: stats_this_month.vip_order_unpaid_count"><?php echo $pay_month['pay_vipno']; ?></b> 笔</div>
                        <div>
                            完成率: <b class="text-warning"><span data-bind="text: Math.round(stats_this_month.vip_order_completion_rate() * 100)"><?php echo $pay_month['pay_vipp']; ?></span> %</b>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-3">
        <div class="well">
            ...
            <div class="text-primary" style="font-size:32px;margin:5px 0">
                ¥<span data-bind="price: stats_all_time.paid_amount"><?php echo $pay_all['pay_num']; ?></span>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6" style="padding:0">
                        <strong>普通充值</strong>
                        <div><b class="text-primary" data-bind="price: stats_all_time.welth_order_paid_amount"><?php echo $pay_all['pay_ptnum']; ?></b></div>
                        <div>已支付: <b class="text-warning" data-bind="text: stats_all_time.welth_order_paid_count"><?php echo $pay_all['pay_ptok']; ?></b> 笔</div>
                        <div>未支付: <b class="text-warning" data-bind="text: stats_all_time.welth_order_unpaid_count"><?php echo $pay_all['pay_ptno']; ?></b> 笔</div>
                        <div>
                            完成率: <b class="text-warning"><span data-bind="text: Math.round(stats_all_time.welth_order_completion_rate() * 100)"><?php echo $pay_all['pay_ptp']; ?></span> %</b>
                        </div>
                    </div>
                    <div class="col-sm-6" style="padding:0">
                        <strong>年费VIP会员</strong>
                        <div><b class="text-primary" data-bind="price: stats_all_time.vip_order_paid_amount"><?php echo $pay_all['pay_vipnum']; ?></b></div>
                        <div>已支付: <b class="text-warning" data-bind="text: stats_all_time.vip_order_paid_count"><?php echo $pay_all['pay_vipok']; ?></b> 笔</div>
                        <div>未支付: <b class="text-warning" data-bind="text: stats_all_time.vip_order_unpaid_count"><?php echo $pay_all['pay_vipno']; ?></b> 笔</div>
                        <div>
                            完成率: <b class="text-warning"><span data-bind="text: Math.round(stats_all_time.vip_order_completion_rate() * 100)"><?php echo $pay_all['pay_vipp']; ?></span> %</b>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo (isset($extra_html) && ($extra_html !== '')?$extra_html:''); ?>
    ...
    <footer id="page-footer" class="content-mini content-mini-full font-s12 bg-gray-lighter clearfix">
        <div class="pull-right">
            Crafted with <i class="fa fa-heart text-city"></i> by <a class="font-w600" href="" target="_blank">火豚中文</a>
        </div>
        <div class="pull-left">
            <a class="font-w600" href="<?php echo config('ieasynet.product_website'); ?>" target="_blank">火豚中文</a> &copy; <span class="js-year-copy"></span>
        </div>
    </footer>
    <?php endif; ?>
    <!-- END Footer -->
...
<script src="__ADMIN_JS__/ieasynet.js"></script>
