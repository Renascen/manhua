<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"D:\test/application/admin\view\module\index.html";i:1512980734;s:42:"D:\test/application/admin\view\layout.html";i:1512980734;s:46:"./application/common/builder/aside/layout.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/recent.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/online.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/switch.html";i:1512980735;}*/ ?>
<!DOCTYPE html>
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="pull-right">
                        <ul class="block-options push-10-t push-10-r">
                            <li>
                                <a href="<?php echo url('cartoon', ['type' => $type]); ?>"><i class="si si-<?php echo !empty($type) && $type=='list'?'list' : 'grid'; ?>"></i></a>
                            </li>
                            <li>
                        ...
                        <div class="row push-20">
                            <div class="col-md-12">
                                ...
                                <div class="toolbar-btn-action">
                                    <a title="全部" class="btn btn-default" href="<?php echo url('cartoon'); ?>">全部(<?php echo (isset($total['all']) && ($total['all'] !== '')?$total['all']:'0'); ?>)</a>
                                    <a title="已启用" class="btn btn-success" href="<?php echo url('cartoon', ['status' => '1']); ?>">已启用(<?php echo (isset($total['1']) && ($total['1'] !== '')?$total['1']:'0'); ?>)</a>
                                    <a title="已禁用" class="btn btn-warning" href="<?php echo url('cartoon', ['status' => '0']); ?>">已禁用(<?php echo (isset($total['0']) && ($total['0'] !== '')?$total['0']:'0'); ?>)</a>
                                    <a title="未安装" class="btn btn-info" href="<?php echo url('cartoon', ['status' => '-1']); ?>">未安装(<?php echo (isset($total['-1']) && ($total['-1'] !== '')?$total['-1']:'0'); ?>)</a>
                                    <a title="已损坏" class="btn btn-danger" href="<?php echo url('cartoon', ['status' => '-2']); ?>" id="hide_disable">已损坏(<?php echo (isset($total['-2']) && ($total['-2'] !== '')?$total['-2']:'0'); ?>)</a>
                                </div>
                            </div>
                        </div>
                        <div class="row module-list push-20">
                            <?php if(empty($modules) || (($modules instanceof \think\Collection || $modules instanceof \think\Paginator ) && $modules->isEmpty())): ?>
                            <div class="table-empty">
                                <div class="text-center empty-info">
                                    <i class="fa fa-database"></i> 暂无数据<br>
                                </div>
                            </div>
                            <?php endif; if($type == 'block'): if(is_array($modules) || $modules instanceof \think\Collection || $modules instanceof \think\Paginator): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$module): $mod = ($i % 2 );++$i;?>
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="block block-rounded">
                                    <div class="block-content block-content-full text-center bg-<?php echo (isset($module['bg_color']) && ($module['bg_color'] !== '')?$module['bg_color']:'danger'); ?> ribbon ribbon-bookmark ribbon-crystal">
                                        <div class="ribbon-box font-w600"><?php echo (isset($module['version']) && ($module['version'] !== '')?$module['version']:'无版本号'); ?></div>
                                        <div class="item item-2x item-circle bg-crystal-op push-20-t push-20 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                                            <i class="<?php echo (isset($module['icon']) && ($module['icon'] !== '')?$module['icon']:'fa fa-puzzle-piece'); ?> text-white-op"></i>
                                        </div>
                                        <h3 class="h4 text-white"><?php echo (isset($module['title']) && ($module['title'] !== '')?$module['title']:'无模块标题'); ?></h3>
                                        <div class="text-white-op">
                                            <em><?php echo (isset($module['name']) && ($module['name'] !== '')?$module['name']:''); ?></em>
                                        </div>
                                    </div>
                                    <div class="block-content bg-gray-lighter">
                                        <div class="<?php echo $module['status_class']; ?> pull-right push-10-l"><?php echo $module['status_info']; ?></div>
                                        <div class="push-10">
                                            <a class="h5" href="<?php echo (isset($module['author_url']) && ($module['author_url'] !== '')?$module['author_url']:''); ?>" target="_blank"><i class="fa fa-user"></i> <?php echo (isset($module['author']) && ($module['author'] !== '')?$module['author']:''); ?></a>
                                        </div>
                                        <div class="push-10 mheight-100">
                                            <div data-toggle="slimscroll" data-height="110px">
                                                <p class="text-gray-dark"><?php echo (isset($module['description']) && ($module['description'] !== '')?$module['description']:'暂无简介'); ?></p>
                                            </div>
                                        </div>
                                        <div class="text-center push">
                                            <?php echo $module['actions']; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; endif; else: echo "" ;endif; else: if(!(empty($modules) || (($modules instanceof \think\Collection || $modules instanceof \think\Paginator ) && $modules->isEmpty()))): ?>
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-builder table-hover table-bordered table-striped">
                                            ...
                                            <tr>
                                                <td><?php echo (isset($module['title']) && ($module['title'] !== '')?$module['title']:'无模块标题'); ?></td>
                                                <td><i class="<?php echo (isset($module['icon']) && ($module['icon'] !== '')?$module['icon']:'fa fa-puzzle-piece'); ?>"></i></td>
                                                <td><?php echo (isset($module['version']) && ($module['version'] !== '')?$module['version']:'无版本号'); ?></td>
                                                <td><a href="<?php echo (isset($module['author_url']) && ($module['author_url'] !== '')?$module['author_url']:''); ?>" target="_blank"><?php echo (isset($module['author']) && ($module['author'] !== '')?$module['author']:''); ?></a></td>
                                                <td><?php echo (isset($module['description']) && ($module['description'] !== '')?$module['description']:'暂无简介'); ?></td>
                                                <td><?php echo $module['actions']; ?></td>
                                            </tr>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </tbody>
                                        </table>
