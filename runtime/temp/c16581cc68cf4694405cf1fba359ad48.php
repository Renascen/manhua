<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:53:"D:\test/application/user/view/admin/index\access.html";i:1512980737;s:42:"D:\test/application/admin/view/layout.html";i:1512980734;s:46:"./application/common/builder/aside/layout.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/recent.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/online.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/switch.html";i:1512980735;}*/ ?>
<!DOCTYPE html>
...
<!-- END Side Content -->
    ...
    <div class="alert alert-<?php echo (isset($tips_type) && ($tips_type !== '')?$tips_type:'info'); ?> alert-dismissable">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <form action="<?php echo url('access'); ?>" name="form-builder" method="post" class="form-horizontal form-builder">
                    <input type="hidden" name="uid" value="<?php echo input('param.uid', ''); ?>">
                    <input type="hidden" name="tab_name" value="<?php echo (isset($tab_name) && ($tab_name !== '')?$tab_name:''); ?>">
                    <div class="block-content tab-content">
                        <div class="tab-pane fade in active push-20">
                            <?php if(!(empty($groups) || (($groups instanceof \think\Collection || $groups instanceof \think\Paginator ) && $groups->isEmpty()))): ?>
                            ...
                            <?php endif; if(!(empty($groups) || (($groups instanceof \think\Collection || $groups instanceof \think\Paginator ) && $groups->isEmpty()))): ?>
                            <table id="group_auth">
                                ...
                                <tr data-tt-id="<?php echo $group[$field_access['primary_key']]; ?>" <?php if($group[$field_access['parent_id']] != '0'): ?>data-tt-parent-id="<?php echo $group[$field_access['parent_id']]; ?>"<?php endif; ?>>
                                    <td>
                                        <label class="css-input css-checkbox css-checkbox-primary">
                                            <input type="checkbox" name="group_auth[]" value="<?php echo $group[$field_access['primary_key']]; ?>" <?php if(in_array(($group[$field_access['primary_key']]), is_array($node_access)?$node_access:explode(',',$node_access))): ?>checked<?php endif; ?>><span></span> <?php echo $group[$field_access['node_name']]; ?>
                                        </label>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
