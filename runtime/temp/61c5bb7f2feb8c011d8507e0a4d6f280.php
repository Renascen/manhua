<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:53:"D:\test/application/agent/view/admin/novel\index.html";i:1512980735;s:42:"D:\test/application/admin/view/layout.html";i:1513080454;s:46:"./application/common/builder/aside/layout.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/recent.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/online.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/switch.html";i:1512980735;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="tab-pane active">
                        ...
                        <div class="row data-table-toolbar">
                            <div class="col-sm-12">
                                ...
                                <form class="pull-right search-bar" method="get" action="<?php echo $search['url']; ?>" role="form">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo input('param.keyword', ''); ?>" name="keyword" placeholder="<?php echo $search['placeholder']; ?>">
                                    </div>
                                </form>
                                <?php endif; ?>
                                ...
                                <div class="toolbar-btn-action">
                                    ...
                                    <div class="form-inline time-filter">
                                        <form action="<?php echo \think\Request::instance()->url(); ?>" class="time-filter" method="get">
                                        <div class="input-daterange input-group" data-date-format="yyyy-mm-dd">
                                            <input class="form-control" type="text" name="_filter_time_from" value="<?php echo (\think\Request::instance()->get('_filter_time_from') ?: ''); ?>" placeholder="开始日期">
                                            <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
                                            <input class="form-control" type="text" name="_filter_time_to" value="<?php echo (\think\Request::instance()->get('_filter_time_to') ?: ''); ?>" placeholder="结束日期">
                                        </div>
                                        <input type="hidden" name="_filter_time" value="<?php echo $_filter_time; ?>">
                        ...
                        <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <th class="column-<?php echo $column['name']; ?> <?php echo (isset($column['class']) && ($column['class'] !== '')?$column['class']:''); ?>">
                                        ...
                                        <?php endif; if (isset($filter_columns[$column['name']])):  
                                         ...
                                         ?>
                                        <a href="javascript:void(0);" class="field-filter pull-right" data-filter="<?php echo $filter_columns[$column['name']]['filter']; ?>" data-options='<?php echo (isset($filter_columns[$column["name"]]["options"]) && ($filter_columns[$column["name"]]["options"] !== '')?$filter_columns[$column["name"]]["options"]:""); ?>' data-map='<?php echo (isset($filter_columns[$column["name"]]["map"]) && ($filter_columns[$column["name"]]["map"] !== '')?$filter_columns[$column["name"]]["map"]:""); ?>' data-field-display="<?php echo $column['name']; ?>" data-field="<?php echo $filter_columns[$column['name']]['field']; ?>" data-table="<?php echo $filter_columns[$column['name']]['table']; ?>" data-toggle="tooltip" data-original-title="筛选"><i class="fa fa-filter <?php if(!in_array(($column['name']), is_array($_field_display)?$_field_display:explode(',',$_field_display))): ?>text-muted<?php endif; ?>"></i></a>
                                        <?php endif; ?>
                                    </th>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </tr>
                            ...
                            <tbody>
                                <?php if(is_array($row_list) || $row_list instanceof \think\Collection || $row_list instanceof \think\Paginator): $k = 0; $__LIST__ = $row_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($k % 2 );++$k;?>
                                <tr>
                                    <?php if((!$hide_checkbox)): ?>
                                    ...
                                    <?php endif; if(is_array($columns) || $columns instanceof \think\Collection || $columns instanceof \think\Paginator): $w = 0; $__LIST__ = $columns;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$column): $mod = ($w % 2 );++$w;?>
                                    <td class="<?php echo (isset($column['class']) && ($column['class'] !== '')?$column['class']:''); ?>">
                                        <?php if($k <= 5 && $w == 3): ?>
                                        <?php echo (isset($row[$column['name']]) && ($row[$column['name']] !== '')?$row[$column['name']]:''); elseif($w == 3): elseif($w == 2): ?>
                                        
                                        <a class="ajax-post confirm pop" href="/admin.php/agent/novel/show/id/<?php echo $row['id']; ?>.html?_pop=1" data-layer="{&quot;type&quot;:2,&quot;area&quot;:[&quot;50%&quot;,&quot;60%&quot;],&quot;shadeClose&quot;:true,&quot;isOutAnim&quot;:false,&quot;anim&quot;:-1}" data-toggle="tooltip"><?php echo (isset($row[$column['name']]) && ($row[$column['name']] !== '')?$row[$column['name']]:''); ?> </a>
                                        <?php else: ?> <?php echo (isset($row[$column['name']]) && ($row[$column['name']] !== '')?$row[$column['name']]:''); endif; ?>
