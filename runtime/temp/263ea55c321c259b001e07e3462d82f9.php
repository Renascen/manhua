<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:61:"D:\test/application/agent/view/admin/statistical\userlog.html";i:1512980735;s:42:"D:\test/application/admin/view/layout.html";i:1512980734;s:46:"./application/common/builder/aside/layout.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/recent.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/online.html";i:1512980735;s:53:"./application/common/builder/aside/blocks/switch.html";i:1512980735;}*/ ?>
<!DOCTYPE html>
   ...
   <div class="row" id="member-summary-stats-panel">
    <div class="col-md-3">
        <div class="well">
            ...
            <div class="text-primary" style="font-size:32px;margin:5px 0">
                <span data-bind="text: stats_today.new_member_count"><?php echo $today['user_num']; ?></span>
                <div style="font-size:13px; line-height: 30px" class="text-muted">
                    男性：<b class="text-warning" data-bind="text: stats_today.male_count"><?php echo $today['user_man']; ?></b> <br>
                    女性：<b class="text-warning" data-bind="text: stats_today.female_count"><?php echo $today['user_women']; ?></b>
                    <br>
                    未知：<b class="text-warning" title="用户未设置性别或未关注而无法获取性别" data-bind="text: stats_today.new_member_count() - stats_today.male_count() - stats_today.female_count()"><?php echo $today['user_weizhi']; ?></b>
                </div>
            </div>
            <div>
                <div>
                    ...
                    <b class="text-warning">
                        <span data-bind="text: stats_today.paid_count"><?php echo $today['user_xiaofei']; ?></span>
                    </b>
                </div>
                <p style="padding: 10px 0 0 0 ">提示：“未知”的定义为用户未设置性别或未关注而无法获取性别</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="well">
            <b>昨日新增</b>
            <div class="text-primary" style="font-size:32px;margin:5px 0">
                <span data-bind="text: stats_today.new_member_count"><?php echo $yesterday['user_num']; ?></span>
                <div style="font-size:13px; line-height: 30px" class="text-muted">
                    男性：<b class="text-warning" data-bind="text: stats_today.male_count"><?php echo $yesterday['user_man']; ?></b> <br>
                    女性：<b class="text-warning" data-bind="text: stats_today.female_count"><?php echo $yesterday['user_women']; ?></b>
                    <br>
                    未知：<b class="text-warning" title="用户未设置性别或未关注而无法获取性别" data-bind="text: stats_today.new_member_count() - stats_today.male_count() - stats_today.female_count()"><?php echo $yesterday['user_weizhi']; ?></b>
                </div>
            </div>
            <div>
                <div>
                    已付费用户:
                    <b class="text-warning">
                        <span data-bind="text: stats_today.paid_count"><?php echo $yesterday['user_xiaofei']; ?></span>
                    </b>
                </div>
                <p style="padding: 10px 0 0 0 ">提示：“未知”的定义为用户未设置性别或未关注而无法获取性别</p>
            </div>
    ...
    <div class="col-md-3">
        <div class="well">
            <b>本月新增  <i class="fa fa-question-circle" ></i></b>
            <div class="text-primary" style="font-size:32px;margin:5px 0">
                <span data-bind="text: stats_today.new_member_count"><?php echo $month['user_num']; ?></span>
                <div style="font-size:13px; line-height: 30px" class="text-muted">
                    男性：<b class="text-warning" data-bind="text: stats_today.male_count"><?php echo $month['user_man']; ?></b> <br>
                    女性：<b class="text-warning" data-bind="text: stats_today.female_count"><?php echo $month['user_women']; ?></b>
                    <br>
                    未知：<b class="text-warning" title="用户未设置性别或未关注而无法获取性别" data-bind="text: stats_today.new_member_count() - stats_today.male_count() - stats_today.female_count()"><?php echo $month['user_weizhi']; ?></b>
                </div>
            </div>
            <div>
                <div>
                    已付费用户:
                    <b class="text-warning">
                        <span data-bind="text: stats_today.paid_count"><?php echo $month['user_xiaofei']; ?></span>
                    </b>
                </div>
                <p style="padding: 10px 0 0 0 ">提示：“未知”的定义为用户未设置性别或未关注而无法获取性别</p>
            </div>
    ...
    <div class="col-md-3">
        <div class="well">
            <b>所有时间 <i class="fa fa-question-circle" ></i></b>
            <div class="text-primary" style="font-size:32px;margin:5px 0">
                <span data-bind="text: stats_today.new_member_count"><?php echo $all['user_num']; ?></span>
                <div style="font-size:13px; line-height: 30px" class="text-muted">
                    男性：<b class="text-warning" data-bind="text: stats_today.male_count"><?php echo $all['user_man']; ?></b> <br>
                    女性：<b class="text-warning" data-bind="text: stats_today.female_count"><?php echo $all['user_women']; ?></b>
                    <br>
                    未知：<b class="text-warning" title="用户未设置性别或未关注而无法获取性别" data-bind="text: stats_today.new_member_count() - stats_today.male_count() - stats_today.female_count()"><?php echo $all['user_weizhi']; ?></b>
                </div>
            </div>
            <div>
                <div>
                    已付费用户:
                    <b class="text-warning">
                        <span data-bind="text: stats_today.paid_count"><?php echo $all['user_xiaofei']; ?></span>
                    </b>
                </div>
                <p style="padding: 10px 0 0 0 ">提示：“未知”的定义为用户未设置性别或未关注而无法获取性别</p>
            </div>
