...
class ElasticSearchHandlerTest extends TestCase
{
    ...
    public function testHandle()
    {
        ...
        $formatter = new ElasticaFormatter($this->options['cartoon'], $this->options['type']);
    ...
    public function testHandleIntegration()
    {
        ...
        $client->request("/{$this->options['cartoon']}", Request::DELETE);
    }
